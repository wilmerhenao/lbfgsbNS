...
2001  format ('RUNNING THE L-BFGS-B CODE',/,/, 'it    = iteration number',/, 'nf    = number of function evaluations', &
           /, 'nseg  = number of segments explored during the Cauchy search', &
           /, 'nact  = number of active bounds at the generalized Cauchy point', & 
           /, 'sub   = manner in which the subspace minimization terminated:', &
           /,'        con = converged, bnd = a bound was reached', &
           /, 'itls  = number of iterations performed in the line search', &
           /, 'stepl = step length used',/,'tstep = norm of the displacement (total step)', &
...
!     ************
 ...
 3003 format (/, &
      '           * * *',/, &
      /,'Tit   = total number of iterations',/,'Tnf   = total number of function evaluations',& 
...
!
!           f(stp) <= f(0) + ftol*stp*f'(0),  // On line 3573
!
!     and the curvature condition
!
!           abs(f'(stp)) <= gtol*abs(f'(0)).  // On line 3589
!
...
!     satisfies the sufficient decrease condition.
!
!     A typical invocation of lineww has the following outline:
!
!     task = 'START'
!  10 continue
!        call lineww( ... )
...
!     The subroutine statement is
!
!        subroutine lineww(f,g,stp,ftol,gtol,xtol,stpmin,stpmax,
!                          task,isave,dsave)
!     where
!
!       f    is a double precision variable.
...
!
!            If task(1:2) = 'FG' then evaluate the function and 
!            derivative at stp and call lineww again.
!
!            If task(1:4) = 'CONV' then the search is successful.
!
!            If task(1:4) = 'WARN' then the subroutine is not able
...
!     **********
      double precision zero,p5,p66
      parameter(zero=0.0d0,p5=0.5d0,p66=0.66d0)
      double precision xtrapl,xtrapu,sgnd
      parameter(xtrapl=1.1d0,xtrapu=4.0d0)
...
!  This is a function
! that finds the solution to the QP problem
!  []
